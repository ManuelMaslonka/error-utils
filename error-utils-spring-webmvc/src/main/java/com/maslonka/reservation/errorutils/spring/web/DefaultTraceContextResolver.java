...
public class DefaultTraceContextResolver implements TraceContextResolver {
    ...
    public TraceContext resolve(HttpServletRequest request) {
        String correlationId = resolveValue(
            request,
            properties.getCorrelationIdRequestAttribute(),
            properties.getCorrelationIdHeader(),
            properties.getCorrelationIdMdcKey()
        );

        String traceId = resolveValue(
            request,
            properties.getTraceIdRequestAttribute(),
            properties.getTraceIdHeader(),
