/**
 * Spring Boot auto-configuration for the {@code error-utils} integration.
 *
 * <p>Consumers usually interact with this package indirectly by adding the starter dependency. The
