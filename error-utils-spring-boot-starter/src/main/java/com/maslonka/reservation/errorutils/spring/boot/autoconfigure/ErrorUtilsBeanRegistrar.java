...
import com.maslonka.reservation.errorutils.spring.web.DefaultTraceContextResolver;
import com.maslonka.reservation.errorutils.spring.web.GlobalApiExceptionHandler;
import com.maslonka.reservation.errorutils.spring.web.NoopErrorMetadataSanitizer;
import com.maslonka.reservation.errorutils.spring.web.TraceContextResolver;
...
public class ErrorUtilsBeanRegistrar implements ImportBeanDefinitionRegistrar {
    ...
    private boolean isSecurityPresent() {
